<?php require '../php/carrito/agregarCar.php'; ?>
                            ...
                            if(isset($_SESSION['carrito'])) {
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control col-md-8 m-auto Cantidad number" min="1" max="<?php echo $datos[$i]['Stock']; ?>" data-precio="<?php echo $datos[$i]['PrecioVenta']; ?>" data-id="<?php echo $datos[$i]['Id']; ?>" value="<?php echo $datos[$i]['Cantidad']; ?>" required>
                                        </td>
                ...
                <div class="card-footer text-muted">
                    <div class="text-right">
                        <p>SUBTOTAL (<b>
                            ...
                            ?></b> ITEMS): <b id="SubTotal"><?php echo 'S/. '.number_format($Subtotal,2); ?></b></p>
