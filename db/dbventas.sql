...
INSERT INTO `provincias` (`IdProvincia`, `Provincia`, `FkDepartamento`) VALUES
(1, 'BAGUA', 1),
(2, 'BONGARA', 1),
(3, 'CHACHAPOYAS', 1),
(4, 'CONDORCANQUI', 1),
...
INSERT INTO `distritos` (`IdDistrito`, `Distrito`, `FkProvincia`) VALUES
(1, 'ARAMANGO', 1),
(2, 'COPALLIN', 1),
(3, 'EL PARCO', 1),
(4, 'IMAZA', 1),
...
INSERT INTO `estados_compra` (`IdEstadoCompra`, `EstadoCompra`) VALUES
(1, 'RECIBIDO'),
(2, 'PARCIALMENTE ENTREGADO'),
(3, 'POR RECIBIR'),
(4, 'RECHAZADO');

INSERT INTO `estados_entrega` (`IdEstadoEntrega`, `EstadoEntrega`) VALUES
(1, 'PARCIAL'),
(2, 'COMPLETO');
...
INSERT INTO `tipos_cargo` (`IdTipoCargo`, `TipoCargo`) VALUES
(1, 'ALMACENERO'),
(2, 'RESPONSABLE DE ENTREGAS');

INSERT INTO `tipos_entrega` (`IdTipoEntrega`, `TipoEntrega`) VALUES
(1, 'TIENDA'),
(2, 'DOMICILIO');
