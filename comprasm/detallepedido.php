...
<body>
 ...
 <div id="montototal">
   ...
   $sql = $db->query("SELECT ti.Direccion,pro.Producto,pr.PrecioCompra,pr.Observacion,pro.Descripcion as descripcion FROM pedidos_compra pr inner join tiendas ti
  ...
  on pr.FkProducto=pro.IdProducto where IdPedidoCompra = ".$productID);
       ...
       if($sql->num_rows > 0){ 
        ...
        ?>
                        ...
                        <p3>Descripcion:</p3>
                        <p4><?php echo $row["descripcion"]; ?></p4><br/><br/>
        ...
        <?php } ?>    
                    ...
                    <a href="index.php"><input type="button" value="ATRAS" id="btng" onclick=""></a>
